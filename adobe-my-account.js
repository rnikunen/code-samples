...
// resizable: false,
// draggable: false,
// title: $("#addressVerificationTitle").text()
//});
...
if(setRegion == "cy" || setRegion == "mt" || setRegion == "gr") { setRegion = "eeurope"; }
...
thisValue = field;
if(value == "screenName") { Adobe.Profile.ScreenName = data["account.screenName"] || "" }
if(value == "jobFunction") { thisValue = data["account.job_function_code"] || ""; }
if(value == "industry") { thisValue = data["account.industry_code"] || ""; }
} else {
